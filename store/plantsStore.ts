...
export const MOCK_RECOMMENDATIONS: PlantRecommendation[] = [
    ...
    },
    {
        ...
        model_archetype: 'perennial_flower',
        mature_height_meters: 0.3,
        mature_width_meters: 0.3,
        why_it_fits: 'A bright, drought-resistant flower that thrives in your soil type.',
        care_difficulty: 'easy',
        watering_frequency_days: 14,
        sunlight_requirement: 'full_sun',
        image_urls: ['https://images.unsplash.com/photo-1543329241-76672fc4d664?auto=format&fit=crop&q=80&w=400'],
        environmental_data: {
            carbon_sequestration_kg_per_year: 0.2,
            water_usage_liters_per_week: 1,
    ...
    },
    {
        ...
        scientific_name: 'Arctostaphylos',
        model_archetype: 'evergreen_shrub',
        mature_height_meters: 2.0,
        mature_width_meters: 2.0,
        why_it_fits: 'Provides excellent year-round structure and supports native birds.',
        care_difficulty: 'moderate',
        watering_frequency_days: 21,
        sunlight_requirement: 'full_sun',
        image_urls: ['https://images.unsplash.com/photo-1628148819028-348f98aaafbc?auto=format&fit=crop&q=80&w=400'],
        environmental_data: {
            carbon_sequestration_kg_per_year: 4.5,
            water_usage_liters_per_week: 2,
            vs_lawn_water_savings_percent: 85,
            native_species: true,
    ...
    },
    {
        ...
        mature_width_meters: 1.0,
        why_it_fits: 'Perfect for the shady, damper areas under your existing trees.',
        care_difficulty: 'easy',
        watering_frequency_days: 7,
        sunlight_requirement: 'partial_shade',
        image_urls: ['https://images.unsplash.com/photo-1596784865181-ed81d58ba6d5?auto=format&fit=crop&q=80&w=400'],
        environmental_data: {
            carbon_sequestration_kg_per_year: 1.0,
            water_usage_liters_per_week: 5,
            vs_lawn_water_savings_percent: 50,
            native_species: true,
            pollinator_support_score: 1,
            biodiversity_score: 3,
